    ...
    <form method="POST" action="<?=$APPLICATION->GetCurPage();?>?lang=<?=LANGUAGE_ID; ?>" ENCTYPE="multipart/form-data" name="dataload" id="dataload">
        ...
        if ($STEP == 2)
        {
            ...
            <tr>
                ...
                <td width="60%">
                    <input type="radio" name="delimiter_r_f" id="delimiter_TZP" value="TZP" <?if ($delimiter_r_f=="TZP" || mb_strlen($delimiter_r_f)<=0) echo "checked"?>><label for="delimiter_TZP"><?echo GetMessage(KitRegions::moduleId . "_EXPORT_ADM_EXP_IMP_DELIM_TZP") ?></label><br>
