    ...
    function DoInstall()
    {
        ...
        if ($_REQUEST['step'] == 1) {
            if ($_SERVER['SERVER_NAME']) {
                $_903582902 = $_SERVER['SERVER_NAME'];
            } elseif ($_SERVER['HTTP_HOST']) {
                $_903582902 = $_SERVER['HTTP_HOST'];
            }
            $_27366326 = '';
            $_1499128467 = \CUpdateClient::GetUpdatesList($_27366326);
            $_1331152558 = array('ACTION' => 'ADD', 'SITE' => $_903582902, 'KEY' => md5('BITRIX' . \CUpdateClientPartner::GetLicenseKey() . 'LICENCE'), 'LICENSE' => $_1499128467['CLIENT'][0]['@']['LICENSE'], 'MODULE' => self::MODULE_ID, 'NAME' => $_REQUEST['Name'], 'EMAIL' => $_REQUEST['Email'], 'PHONE' => $_REQUEST['Phone'], 'BITRIX_DATE_FROM' => $_1499128467['CLIENT'][0]['@']['DATE_FROM'], 'BITRIX_DATE_TO' => $_1499128467['CLIENT'][0]['@']['DATE_TO'],);
            $_1409866338 = array('http' => array('method' => 'POST', 'header' => 'Content-Type: application/json; charset=utf-8
', 'content' => json_encode($_1331152558)));
            $_1079604733 = stream_context_create($_1409866338);
            $_1000032587 = file_get_contents('https://www.sotbit.ru:443/api/datacollection/index.php', 0, $_1079604733);
