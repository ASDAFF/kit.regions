...
class SotbitRegions
{
    ...
    {
        if (is_null(self::$_1141523686)) {
            self::__1004972562();
        }
        if (self::$_1141523686 == 0 || self::$_1141523686 == 3) {
            return true;
        } else {
            return false;
        }
    ...
    private static function __1004972562()
    {
        self::$_1141523686 = \Bitrix\Main\Loader::includeSharewareModule(self::moduleId);
    }
