    ...
    <div class="select-city__modal-wrap">
        <div class="select_city-modal-title">
            <div class="modal_title-text-wrapper">
                <span class="title"><?= Loc::getMessage(SotbitRegions::moduleId . '_SELECT_REGION') ?></span>
                <span class="current_region-title"><?= Loc::getMessage(SotbitRegions::moduleId . '_YOUR_REGION') ?></span>
            ...
            <div class="city_modal-content-wrapper">
                ...
                <div class="select-city__tab_content active">
                    <div class="select-city__list_wrapper">
                        ...
                        ><?= Loc::getMessage(SotbitRegions::moduleId . '_BIG_CITIES') ?></div>
