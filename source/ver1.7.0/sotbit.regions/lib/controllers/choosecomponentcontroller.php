...
use Sotbit\Regions\System\LocationAbstarctHeandler;

class ChooseComponentController extends Controller
{

    // const COOKIE_SHOW_REQGION_QUESTION = 'sotbit_regions_city_choosed';
    const COOKIE_REGION_ID = 'sotbit_regions_id';
    const COOKIE_REGION_LOCATOON_ID = 'sotbit_regions_location_id';
    ...
    {
        $controller = "sotbit:regions.ChooseComponentController.{$action}";
