...
<tr><td colspan="2">
    <div align="left" class="adm-info-message-wrap"><div class="adm-info-message">
        ...
        <ol>
            ...
            <li>Выгрузить файл с наименованием городов <p> Переходим в KIT->Мультирегиональность->Настройки-> [s1] Магазин-> Добавить языки. <p> Указываем страну Україна, указываем кодировку файла выгрузки (пример windows-1251), нажимаем кнопку "Выгрузить файлы" </li>
        ...
        <div>Переходим в KIT->Мультирегиональность->Настройки-> [s1] Магазин-> Добавить языки, нажимаем кнопку «Добавить файл». Все переводы наименований городов  хранятся в таблице b_sale_loc_name.</div>
</div></div>
</td></tr>
';